        ...
        <div class="h-100 w-100 row align-items-center">
            ...
            <div class="col-12 col-lg-5">
                <div class="bounceInDown animated">
                    <h1 class="font-weight-bold text-coekku display-4">Peeranat's Grader</h1>
                    ...
                    <a class="btn btn-coekku" target="_blank" href="https://github.com/Nepumi-Jr/HowToUseGraderGa/blob/main/How%20to%20use%20Graderga.pdf">วิธีการใช้งาน</a>
                    <?php
